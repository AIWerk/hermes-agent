        ...
        with self._state_lock:
            clients = [
                {"server_id": c.server_id,
                 "workspace_root": c.workspace_root or (c.workspace_folders[0] if c.workspace_folders else ""),
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        with self._state_lock:
            clients = [
                {
                    "server_id": k[0],
                    "workspace_root": c.workspace_root or (c.workspace_folders[0] if c.workspace_folders else k[1]),
