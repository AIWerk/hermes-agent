    ...
    for i, tool_call in enumerate(assistant_message.tool_calls, 1):
        ...
        if function_name == "todo":
            ...
            def _execute(next_args: dict) -> Any:
                ...
                # Mirror only successful, actually executed built-in memory
                # writes. Middleware-blocked requests never reach this callback.
                ...
                return result
            function_result, function_args, middleware_trace, _execution_blocked = _managed_values(
