...
def _config_cache_key(config_path: Path, raw_config: str) -> Optional[Tuple[str, int, int, int, bytes]]:
...
def _load_raw_config() -> Dict[str, Any]:
    ...
    try:
        ...
        return {}
    cache_key = _config_cache_key(config_path, raw_config)
...
def get_external_skills_dirs() -> List[Path]:
    ...
    try:
        ...
        raw_config = ""
    full_key = _config_cache_key(config_path, raw_config)
