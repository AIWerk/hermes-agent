...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Exact current time, date, timezone → use terminal (e.g. date). Exception: "
    "if a trusted temporal_context block is already injected, it is enough for "
    "coarse relative-time classification (morning/afternoon, today/tomorrow, "
    "weekday/weekend, local daypart) unless the user asks for exact time or an "
    "operational decision depends on it.\n"
