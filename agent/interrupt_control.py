...
class InterruptControlMixin:
    ...
    def redirect(self, text: str) -> bool:
        ...
        def _admit_redirect() -> bool:
            ...
            at_commit_fence = bool(_response_pending is not None and _response_pending.is_set())
    ...
    def _close_turn_correction_admission(self, *, preserve_pending: bool = False) -> None:
        steer_lock = getattr(self, "_pending_steer_lock", None)
