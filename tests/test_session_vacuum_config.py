...
class FakeSessionDB:
    def __init__(self, db_path: Path):
        ...
        self.get_meta = MagicMock(return_value="already-done")
        self.set_meta = MagicMock()
        self.prune_empty_ghost_sessions = MagicMock()
        self.finalize_orphaned_compression_sessions = MagicMock()
        self.maybe_auto_archive = MagicMock()
        self.maybe_auto_prune_and_vacuum = MagicMock()
...
def test_fresh_config_runs_auto_prune_at_startup(monkeypatch, tmp_path: Path):
    ...
    session_db = FakeSessionDB(tmp_path / "state.db")
