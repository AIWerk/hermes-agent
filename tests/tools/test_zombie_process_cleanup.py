...
class TestDelegationCleanup:
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        # Keep the timeout short enough to exercise deferred cleanup, but long
        # enough for the fresh executor thread to start under a loaded parallel
        # suite. The child remains blocked well beyond this deadline.
