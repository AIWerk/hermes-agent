...
# AIWerk retained state, FTS, and session-isolation contracts live in the facade mixins.
        ...
        while True:
            ...
            try:
                ...
                if isinstance(exc, sqlite3.DatabaseError):
                    ...
                    # rows are intact: try one in-place rebuild, then detach derived indexes and retry.
                    ...
                    if self._is_structural_corruption_error(exc) or is_malformed_db_error(exc):
