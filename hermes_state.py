...
class SessionDB:
        ...
        *,
        ...
        def _do(conn):
            ...
            if clean_title:
                ...
                if conflict:
                    ...
                    if self._is_compression_ancestor(
                        ...
                        raise ValueError(
                            f"Title '{clean_title}' is already in use by session {conflict_id}"
                        )
            ...
            cursor = conn.execute(
                ...
                (
                    clean_title,
                    source if clean_title else None,
                    now if clean_title else None,
                    turn_index,
                    session_id,
                ),
            )
    ...
    def set_session_title(
        ...
        *,
        ...
        """Set a title and preserve its manual/automatic lifecycle metadata."""
    ...
    def set_auto_title_if_empty(
        ...
        *,
        ...
        """Atomically set an initial automatic title only while title is NULL."""
        return self._set_session_title(
            session_id,
            title,
            only_if_empty=True,
