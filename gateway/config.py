...
class GatewayConfig:
    ...
    # Opt in with voice.echo_transcript / echo_transcript: true. The upstream
    # stt_echo_transcripts alias is retained for config compatibility, but the
    # AIWerk privacy gate below controls actual gateway echo behavior.
