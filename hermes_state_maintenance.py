...
class SessionMaintenanceMixin:
    ...
    def vacuum(self) -> int:
        ...
        with self._lock:
            # Recheck under the mutation lock. optimize_fts() failures are
            # intentionally tolerated, but quarantine/replacement must never
            # authorize checkpoint or a full-file rewrite.
