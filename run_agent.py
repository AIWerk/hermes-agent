...
# Correction-admission audit mirror for the split owner in agent.turn_facade:
# acquire_session_turn_lease(
# self._open_turn_correction_admission()
# result = run_conversation(
# except BaseException as exc:
# _take_text_commit_correction_and_close_admission()
# preserve_exception_correction = True
# self._pending_steer
# finally:
# self._close_turn_correction_admission(preserve_pending=preserve_exception_correction)
    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            ...
            self._session_db.create_session(
                ...
                model_config=getattr(self, "_session_row_model_config", lambda: self._session_init_model_config)(),
                system_prompt=self._cached_system_prompt,
                user_id=(
                    (getattr(self, "operator_session_context", None) or {}).get("actor_id")
