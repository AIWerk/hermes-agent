...
class AuthStoreReadError(AuthError, OSError):
    """Unreadable auth store: preserve both auth and OS-error contracts."""
...
def _load_auth_store(auth_file: Optional[Path] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        # The file exists but could not be read (fd exhaustion, EIO, a stalled
        # mount, etc.). Never degrade to an empty store: a later save could
        # erase every stored credential.
        logger.warning(
