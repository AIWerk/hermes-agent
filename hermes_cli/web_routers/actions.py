...
_resolve_gateway_restart_target = late("_resolve_gateway_restart_target", "hermes_cli.web_server_gateway")
...
def _actor_identity_from_request(request: Request) -> Dict[str, Any]:
...
async def restart_gateway(request: Request, profile: Optional[str] = None):
    ...
    if getattr(request.app.state, "auth_required", False):
        ...
        decision = evaluate_cui_mutation(
            ...
            actor=actor,
            target_tenant_id=target_tenant_id or actor.get("tenant_id"),
        )
