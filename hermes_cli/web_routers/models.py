...
_EMPTY_MODEL_INFO: dict = {
    ...
    "effective_context_length": 0, "capabilities": {}, "agent_name": "Agent",
}
...
def get_model_info(profile: Optional[str] = None):
    ...
    try:
        ...
        agent_name = _dashboard_agent_name(cfg)
        ...
        if not model_name:
            return dict(_EMPTY_MODEL_INFO, provider=provider, agent_name=agent_name)
