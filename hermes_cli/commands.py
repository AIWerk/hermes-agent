...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("fresh", "Start a new session with read-only recent context", "Session",
               args_hint="[message-count]",
               busy_policy="interrupt_then_dispatch", busy_handler="new"),
...
for _split_owner_name in (
    ...
    globals().pop(_split_owner_name, None)
