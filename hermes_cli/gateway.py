...
def _gateway_run_command(service_hermes_home: Path | None = None) -> list[str]:
    ...
    """
    python_path = (
        get_python_path(service_hermes_home)
        if service_hermes_home is not None
...
def _timestamped_stderr_gateway_command(
    error_log: Path,
    *,
    service_hermes_home: Path | None = None,
) -> list[str]:
    ...
    return [
        ...
        str(error_log),
        "--",
        *_gateway_run_command(service_hermes_home),
    ]
