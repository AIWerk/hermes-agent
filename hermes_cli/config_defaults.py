...
# AIWerk-owned config overlays. Keep upstream's canonical defaults intact and
# layer only the product/runtime additions that do not exist upstream.
...
DEFAULT_CONFIG["browser"]["local_launcher"] = {
    "enabled": False,
    "launcher_port": 18765,
...
DEFAULT_CONFIG["honcho"]["injection_preview"] = {
    "on_new_session": True,
    "on_clear": True,
    "fail_quietly": True,
}
DEFAULT_CONFIG["memory"]["router"] = {
    "enabled": True,
    "block_non_inject_writes": True,
}
DEFAULT_CONFIG["security"]["operator_verification"] = {
    "enabled": True,
    "ttl_seconds": 900,
