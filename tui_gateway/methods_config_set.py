...
def _(rid, params: dict) -> dict:
    ...
    session = _visible_live_session(str(requested_session)) if requested_session else None
    ...
    if requested_session and session is None and handler in {
        _set_model, _set_fast, _set_verbose, _set_cwd, _set_prompt, _set_personality, _set_skin,
    }:
