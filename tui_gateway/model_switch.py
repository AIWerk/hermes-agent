...
if TYPE_CHECKING:
    from tui_gateway.server import (
        _append_model_switch_marker, _clear_session_context, _config_model_target,
        _emit, _emit_session_info, _persist_live_session_runtime,
        _persist_live_session_system_prompt, _rebuild_session_agent, _resolve_model,
        _restart_slash_worker, _session_cwd, _session_source, _set_session_context,
        _start_agent_build, logger,
    )
